# donkeychat.Duke project template
...
3. After that, locate the `src/main/java/donkeychat.Duke.java` file, right-click it, and
   choose `Run donkeychat.Duke.main()` (if the code editor is showing compile errors, try restarting the IDE). If the
