...
public class EventParserTest {
    ...
    public void shouldNotAcceptEmptyTask() {
        assertThrows(MissingArgumentException.class, () -> new EventParser().parse(" /from 2023-01-01 /to 2024-01-01"));
    }

    @Test
    public void shouldNotAcceptMissingStartDate() {
        assertThrows(MissingArgumentException.class, () -> new EventParser().parse("demo /to 2024-01-01"));
    }

    @Test
    public void shouldNotAcceptEmptyStartDate() {
        assertThrows(MissingArgumentException.class, () -> new EventParser().parse("demo /from  /to 2024-01-01"));
    }
    ...
    public void shouldNotAcceptMissingEndDate() {
        assertThrows(MissingArgumentException.class, () -> new EventParser().parse("demo /from 2023-01-01"));
    }

    @Test
    public void shouldNotAcceptEmptyEndDate() {
        assertThrows(MissingArgumentException.class, () -> new EventParser().parse("demo /from 2023-01-01 /to "));
    }
