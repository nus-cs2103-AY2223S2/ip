...
public class EventTest {
    ...
    public void checkDate() {
        Event event = new Event("Body", LocalDateTime.of(2023, 3, 4, 11, 35), LocalDateTime.of(2023, 3, 4, 14, 20));
        assertTrue(event.beforeDate(LocalDateTime.of(2023, 3, 4, 11, 35)));
        assertFalse(event.beforeDate(LocalDateTime.of(2023, 3, 4, 11, 34)));
        assertTrue(event.afterDate(LocalDateTime.of(2023, 3, 4, 14, 20)));
        assertFalse(event.afterDate(LocalDateTime.of(2023, 3, 4, 14, 21)));
    }
