...
public class TaskList {
     ...
     *
     * @param parsedTaskInfo ArrayList of String type that contains parsed information about the task description and
    ...
    public String addTask(ArrayList<String> parsedTaskInfo, Storage file) {   // returns message that needs to be printed to user
        ...
        case 2: // new ToDo task
            newTask = new ToDos(parsedTaskInfo.get(1));
            break;
        case 3: // new ToDo (COMPLETED) task
