...
public class AddCommand extends Command {
    ...
    public AddCommand(String keyword, ArrayList<String> params) {
    ...
    public void execute(TaskList tasks, Ui ui, Storage storage) throws DukeException {
        ...
        case EVENT:
            ...
            try {
                addedTask = new Event(this.params.get(0), LocalDate.parse(this.params.get(1)), LocalDate.parse(this.params.get(2)));
            } catch (DateTimeParseException e) {
                throw new IllegalInputException("You have keyed in an invalid date");
            }
            break;
