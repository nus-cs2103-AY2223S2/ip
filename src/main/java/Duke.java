...
public class Duke {
    // /**
    // * Returns a boolean value after checking if the string contains only
    // numerical
    // * value.
    // *
    // * <p>
    ...
    // /**
    // * @param input an array of string elements that the user input via the
    // Scanner
    // * object.
    ...
    // && (input[0].equals("mark") || input[0].equals("unmark") ||
    // input[0].equals("delete"))) {
    ...
    // if ((input[0].equals("deadline") && !hasBy) || (input[0].equals("event") &&
    // (!hasFrom || !hasTo))) {
    ...
    public static void main(String[] args) {
        ...
        CommandMap loop = CommandMap.todo;
        ...
        while (loop != CommandMap.bye) {
            try {
                loop = Parser.readCommand(inputScanner.nextLine(), list);
                ...
                // System.out.println(list.getTask(unmarkedIndex));
                // break;
                // case "todo":
                ...
                // String dDate = String.join(" ", Arrays.copyOfRange(input, deadlineIndex + 1,
                // input.length));
                // try {
                ...
                // System.out.println("Invalid date format. Please input the right format
                // <yyyy-mm-dd>.");
                // }
                // break;
                // case "event":
                ...
                // String eFrom = String.join(" ", Arrays.copyOfRange(input, fromIndex + 1,
                // toIndex));
                // String eTo = String.join(" ", Arrays.copyOfRange(input, toIndex + 1,
                // input.length));
