...
import wtd.command.CreateDeadline;
import wtd.command.CreateEvent;
import wtd.command.CreateTodo;
import wtd.command.Remove;
import wtd.command.Exit;
import wtd.command.Find;
import wtd.command.List;
import wtd.command.Mark;
import wtd.command.Set;
import wtd.command.Unmark;
import wtd.exceptions.WtdException;
import wtd.exceptions.InsufficientArgumentsException;
import wtd.exceptions.InvalidArgumentException;
import wtd.exceptions.InvalidCommandException;
...
public class Parser {
     ...
     * @throws WtdException
     */
    public static Command parse(String fullCommand) throws WtdException {
     ...
     * @throws WtdException
     */
    public static void handleInsufficientArgs(String command) throws WtdException {
        switch (command) {
        case "todo":
