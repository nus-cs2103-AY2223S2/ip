...
public class DukeExceptions {
    ...
    /**
     * Checks whether a description is present when describing a task or an action (Todo, Deadline, Event, Mark, Unmark),
     * If no description is present, then it throws an EmptyDescriptionException
    ...
    static void checkCommand(String command[]) throws DontKnowWhatThatMeansException {
        String[] commandArray = {"mark", "unmark", "todo", "delete", "deadline", "event", "list", "bye", "find"};
        boolean check = false;
