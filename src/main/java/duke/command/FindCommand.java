...
/**
 * A command that stores the command to find all tasks that match the specific term as a substring.
 * The action of finding the tasks that match can be carried out when called.
 */
public class FindCommand extends Command {
    ...
    /**
     * Finds all tasks that matches the finding term.
     * Display out a numbered list of all of these tasks.
     *
