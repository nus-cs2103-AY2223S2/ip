...
/**
 * A command that stores the command to find all tasks that match the specific
 * term as a substring. The action of finding the tasks that match can be
...
public class FindCommand extends Command {
    ...
    /**
     * Constructor for a command to find all tasks that match the specific keyword
     * as a substring.
     *
    ...
    /**
     * Finds all tasks that matches the finding term. Display out a numbered list
