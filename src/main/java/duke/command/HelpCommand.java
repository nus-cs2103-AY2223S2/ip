...
public class HelpCommand extends Command {
    ...
    public void execute(TaskList tasks, Ui ui, Storage storage) throws DukeException {
        String HELP_MESSAGE = "Here are the available commands and their respective function: \n\n" +
                ...
                "- massDelete : Delete all the tasks that have been marked as done.\n\n" +
                ...
                ;
        ui.appendResponse(HELP_MESSAGE);
    }
}
