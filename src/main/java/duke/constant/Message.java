...
public class Message {
    /* Exception constants */
    public final static String EXCEPTION_NOSUCH_COMMAND = "I'm sorry, but I don't know what that means :-(";
    public final static String EXCEPTION_INVALID_TODO_ID = "Invalid task id! Task id must be a number.";
    public final static String EXCEPTION_INVALID_TODO_ID_ACCESS = "Unable to find task.";
