...
public class DeleteCommand implements Command {
    ...
    /**
     * Returns a Tasklist object which is the current taskList after executing delete task command and deletes the
     * task given in the parsedCommand from the taskList and hard disk.
     *
