...
public class Parser {
    ...
    public void parse(String input) {
        ...
        try {
            if (arrNext.length <= 1) {
                if (Objects.equals(next, "todo") || Objects.equals(next, "deadline") || Objects.equals(next, "event") || Objects.equals(next, "mark") || Objects.equals(next, "unmark") || Objects.equals(next, "delete") || Objects.equals(next, "find")) {
