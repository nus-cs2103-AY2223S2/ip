...
class Parser { 
    ...
    static String FIND_COMMAND = "Here are matching tasks in your list sir";
    //Whitelist commands
    ...
    */
     ...
     * as done 
     *
     * @param taskPosition The index of the task in the list of tasks,
     * starting from 1. 
     * @param tasks The list of tasks to be processed 
     * @param <Task> Type of element stored in the TaskList
     *
     * @return TaskList<Task> The new TaskList with the corresponding task
     * marked as done
     *
     * @see TaskList
     */
     ...
     * @param <Task> Type of element stored in the TaskList
     *
     * @return TaskList<Task> New list of tasks with the latest being the
     * todo task added 
     *
