...
public class TaskList implements List<Task>, Serializable {
  ...
  @Override
  public boolean contains(Object o) { return tasks.contains(o); }
  ...
  @Override
  public boolean remove(Object o) { return tasks.remove(o); }
  
  @Override
  public Task set(int index, Task t) { return tasks.set(index, t); }
