...
/**
 * A todo task object that stores its description and on whether is it done or
...
public class Todo extends Task {
  ...
  /**
   * Constructor for a todo task with the provided description and its status of
   * completion.
   *
   * @param description The description of the todo task
  ...
  /**
   * Checks on whether the string representation of the todo task is the same
  ...
  public String toData() {
    return String.format("Todo | marked: %s ; description: %s",
