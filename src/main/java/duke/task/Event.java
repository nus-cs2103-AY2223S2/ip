...
public class Event extends Task {
     ...
     * It checks on whether the start and end dates are in the appropriate format first. If it is not, an exception is
    ...
    public String toData() {
        ...
        return String.format("Event | marked: %s ; description: %s ; from: %s ; to: %s", getMarkedStatus(), description,
