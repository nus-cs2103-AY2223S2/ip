...
public class Task {
   ...
   */
  public void markTask() { isDone = true; }

  /**
   * Unmark the task as not done.
   */
  public void unmarkTask() { isDone = false; }
   ...
   */
  public boolean isEmpty() { return equals(EMPTY_TASK); }
   ...
   */
  public String getMarkedStatus() { return isDone ? "1" : "0"; }
