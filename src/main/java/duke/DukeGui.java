...
public class DukeGui extends Application {
    ...
    private static final String ICON_RESOURCE_PATH = "/images/ipman-profile.png";
    ...
    public void start(Stage stage) {
        ...
        try {
            ...
            stage.getIcons().add(new Image(this.getClass().getResourceAsStream(ICON_RESOURCE_PATH)));
