...
public class PracticeGUI extends Application {
    private Image user = new Image(this.getClass().getResourceAsStream("/images/Luffy.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/LuffyReply.png"));
    ...
    private void handleUserInput() {
        ...
        userText.setFont(Font.font("Arial", 15));
        dukeText.setFont(Font.font("Arial", 15));
