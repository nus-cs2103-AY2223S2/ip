...
public class Parser {
     ...
     */
    private static ToDo getTodo(String[] splitInputs) throws IncompleteDescException {
     ...
     */
    private static Deadline getDeadline(String[] splitInputs) throws IncompleteDescException, InvalidInputException {
     ...
     */
    private static Event getEvent(String[] splitInputs) throws IncompleteDescException, InvalidInputException {
        if (splitInputs.length <= 1) {
            throw new IncompleteDescException(
     ...
     */
    public static Command parseCommand(String input) throws IncompleteDescException, InvalidInputException {
