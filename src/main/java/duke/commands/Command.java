...
public abstract class Command implements BiConsumer<String[], Duke> {
  /**
   * Represents errors in the user's input. Throw this exception within {@link #execute() execute} with the given message
   * to indicate that the user has entered invalid arguments for the given command.
   */
