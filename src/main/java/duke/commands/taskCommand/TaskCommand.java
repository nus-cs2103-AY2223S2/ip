...
/**
 * A subclass of {@link Command Commands} that return tasks to be added to the TaskList. Override the {@link #getTask(String[], Duke) getTask()} function
...
public abstract class TaskCommand<T extends Task> extends Command {
  ...
  /**
   * Called when the command is executed to return a {@link Task task} to be added to the Duke instance. Follows the calling
   * conventions of {@link #execute(String[], Duke) execute}.
