...
public class DialogBox extends HBox {
     ...
     * Specifically, the dialog box is right aligned with the respective text and profile image of the user.
     *
     * @param text  The text to be displayed
     * @param image The profile image
     ...
     * Specifically, the dialog box is left aligned with the respective text and profile image of the chatbot.
     *
     * @param text  The text to be displayed
     * @param image The profile image
