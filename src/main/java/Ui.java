public class Ui {
  ...
  public static void markTask(TaskArrayList tasks, String input) throws DukeException {
    int index;
    try {
  ...
  public static void unmarkTask(TaskArrayList tasks, String input) throws DukeException {
    int index;
    try {
      index = Integer.parseInt(input.split(" ")[1]) - 1;
  ...
  public static void confirmAddedTask(TaskArrayList tasks, Task task) {
    System.out.println("New task added:");
    System.out.println(task.toString());
    System.out.println("Now you have " + tasks.size() + " tasks in the list.");
  }

  public static void addToDo(TaskArrayList tasks, String input) throws DukeException {
  ...
  public static void addDeadline(TaskArrayList tasks, String input) {
    String[] spaceSplit = input.split(" ", 2);
  ...
  public static void addEvent(TaskArrayList tasks, String input) {
    String[] spaceSplit = input.split(" ", 2);
  ...
  public static void deleteTask(TaskArrayList tasks, String input) throws DukeException {
    int index;
    try {
      index = Integer.parseInt(input.split(" ")[1]) - 1;
