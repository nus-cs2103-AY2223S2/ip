...
public class Wcwidth {
    ...
    public static void main (String[] args) {
        String test = ConsoleColors.GREEN + "✓" + ConsoleColors.RESET;
        System.out.println(test);
        System.out.println(strWidth(test));
        System.out.println(test.length());
        for (int i = 0; i < test.length(); i++) {
            System.out.print(test.codePointAt(i) + ", ");
        }

        String test2 = "✓";
        System.out.println(test2);
        System.out.println(strWidth(test2));
        System.out.println(test2.length());
        for (int i = 0; i < test2.length(); i++) {
            System.out.print(test2.codePointAt(i) + ", ");
        }
    }
    ...
    /** (Added by me)
     * Gets the total character width of a string
     * Calls of on every character and sums it up
     * @param str is the string to measure the width of
     * @return the number of character cells taken to display str
     */
    public static int strWidth(String str) {
        int total = 0;
        boolean skip = false;
        for (int i = 0; i < str.length(); i++) {
            if (str.codePointAt(i) == 27) {
                skip = true;
                total--;
