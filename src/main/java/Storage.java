...
public class Storage {
    ...
    public void save(TaskList list) throws SaveException {
        try {
            ...
            throw new SaveException("There was an issue recording down your Book.");
        }
    }
        ...
        try {
            ...
            while (fileReader.hasNextLine()) {
                ...
                case "E":
                    ...
                    break;
                default:
                    throw new LoadException("The saved Book is corrupted.");
                }
            ...
            throw new LoadException("There was an issue finding the saved Book.");
        }
    }
