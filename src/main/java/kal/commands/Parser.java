...
public class Parser {
    ...
    private void checkLength(String str) throws KalException {
        if (str.isEmpty()) {
            throw new EmptyFieldException();
        }
    }

    private void checkDate(String str) throws KalException {
        if (str.isEmpty()) {
     ...
     * @throws KalException when command is invalid.
     */
    public Command process() throws KalException {
